...
class FirstPlayerPage extends StatefulWidget {
  ...
  @override
  State<FirstPlayerPage> createState() => _FirstPlayerPageState();
}

class _FirstPlayerPageState extends State<FirstPlayerPage> {
  ...
  Future<void> _initializeModel() async {
    ...
    Provider.of<TwoPlayersNotifier>(context, listen: false).registerClearPadFirst(_clearPad);
  }
